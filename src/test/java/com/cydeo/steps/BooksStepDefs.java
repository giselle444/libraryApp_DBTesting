...
public class BooksStepDefs {
    ...
    public void book_information_must_match_the_database_for(String string) {
        ...
        System.out.println("bookPage.books.getAttribute(\"innerHTML\") = " + bookPage.books.getAttribute("innerHTML"));


        /*
       1.getText()--> will return text from provided element
       2.getAttribute("value")--> if theres inputbox
        we will use getAttribute("value") to get data from here
